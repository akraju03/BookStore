 ...
 * Generated at: 2017-11-26 09:32:03 UTC
...
if(r.isAdmin(session)){
      ...
      out.write("            <form action=\"AddNewGanreServlet\" method=\"post\">\n");
      out.write("                <label>Add new Ganre:</label>\n");
      out.write("                <input type=\"text\" name=\"title\" id=\"name\" placeholder=\"title\"/>\n");
...
for (Ganre g : ganres) {
      ...
      out.print(g.getId());
      out.write(" </td> \n");
      out.write("                <td><a href=\"ganre.jsp?ganreId=");
      out.print(g.getId());
      out.write('"');
      out.write('>');
